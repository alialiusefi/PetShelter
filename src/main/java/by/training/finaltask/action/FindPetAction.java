        ...
        if (session != null) {
            ...
            if (pets == null && petPicturePaths == null) {
                ...
                if (user != null && allowedRoles.contains(user.getUserRole())) {
                    amountOfAllPets = petService.getAllCountByStatus(null);
                } else {
                    amountOfAllPets = petService.getAllCountByStatus(PetStatus.SHELTERED);
                }
                ...
                if (user != null && allowedRoles.contains(user.getUserRole())) {
                    pets = petService.getAllByStatus(null,offset, ROWCOUNT);
                } else {
