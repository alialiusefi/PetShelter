...
<br>
<div class="table mx-auto" style="max-width: 70%;">
    <table>
        <thead>
        <tr>
                    ...
                    <div class="row">
                        <form action="<c:url value="/adoptions/editadoption.html"/>"
                            ...
                            <div class="col mx-0">
                                ...
                                <input type="submit" class="btn btn-secondary btn-sm" value="<fmt:message key="edit"/>">
                            </div>
                        </form>
                        ...
                        <form action="<c:url value="/pets/moreinfopet.html"/>"
                              method="post" class="form-inline">
                            <div class="col mx-0">
                                <input type="hidden" name="petID" value="${adoptions.petID}">
                                <input type="submit" class="btn btn-secondary btn-sm"
                                       value="<fmt:message key="moreInfo"/>">
                            </div>
                        </form>
                    </div>
                </td>
...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <a href="<c:url value="/adoptions/guest/myadoptions.html?page=1"/>" class="btn btn-success">
